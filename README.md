...
**Influx DB**
Data collected by the Arduinos will not be saved unless Influx DB is runing. Typically it is running. You can verify its presence by accessing the url localhost:8086. If the influx ui doesn't pop up, that should indicate that Influx isn't actually runnng.
